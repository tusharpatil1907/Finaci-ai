...
def index(request):
    ...
    fig_left.add_trace(
                go.Scatter(x=data['Date'], y=data['JPM']['Adj Close'], name="TCS.NS")
            )
    fig_left.add_trace(
                go.Scatter(x=data['Date'], y=data['JPM']['Adj Close'], name="INFY.NS")
            )
    fig_left.add_trace(
                go.Scatter(x=data['Date'], y=data['JPM']['Adj Close'], name="RELIANCE.NS")
            )
    ...
    df6.insert(0, "Ticker", "NVDA")


    df7.insert(0, "Ticker", "INFY.NS")
    df8.insert(0, "Ticker", "TCS.NS")
    df9.insert(0, "Ticker", "RELIANCE.NS")
    ...
    ind = pd.concat([df7, df8, df9, df4], axis=0)
